    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-content collapse show">
          <div class="card-body">
          <a href='consultas/material/consulta.php'><button type="button" class="btn btn-warning btn-min-width mr-1 mb-1">Materiais</button></a>
          <a href='consultas/tecnicos/consulta.php'><button type="button" class="btn btn-warning btn-min-width mr-1 mb-1">Técnicos</button></a>
          <a href='consultas/professor/consulta.php'><button type="button" class="btn btn-warning btn-min-width mr-1 mb-1">Professores</button></a>
          <a href='consultas/tipo/consulta.php'><button type="button" class="btn btn-warning btn-min-width mr-1 mb-1">Tipo de Material</button></a>
          </div>
        </div>
      </div>
    </div>
