...
<section class="basic-inputs">
  <div class="row match-height"> 
              ...
              <div class="card-block">
                  <div class="card-body">
                      <fieldset class="form-group">
                          <form method="POST" action="cadastros/professor.php">
                            <p>Nome</p>
                            <input type="text" class="form-control" id="basicInput" name="txt_nome_prof" > <br>
                            <br>
                            <button type="submit" class="btn btn-info btn-min-width mr-1 mb-1">Cadastrar</button>
                          </form>
                      </fieldset>
                  </div>
              </div>
      ...
      <!-- Cadastro professor end -->

      <!-- Cadastro tecnicos start -->
      <div class="col-xl-4 col-lg-6 col-md-12">
          <div class="card">
              <div class="card-header">
              ...
              <div class="card-block">
                  <div class="card-body">
                      <fieldset class="form-group">
                          <form method="POST" action="cadastros/tecnicos.php">
                            <p>Nome</p>
                            <input type="text" class="form-control" id="basicInput" name="txt_nome_tec"> <br>
                            <br>
                            <button type="submit" class="btn btn-info btn-min-width mr-1 mb-1">Cadastrar</button>
                          </form>
                      </fieldset>
      ...
      <div class="col-xl-4 col-lg-6 col-md-12">
          <div class="card">
              ...
              <div class="card-block">
                  <div class="card-body">
                      <fieldset class="form-group">
                          <form method="POST" action="cadastros/tipo.php">
                            <p>Descrição</p>
                            <input type="text" class="form-control" id="basicInput" name="txt_descricao_tipo"> <br>
                            <br>
                            <button type="submit" class="btn btn-info btn-min-width mr-1 mb-1">Cadastrar</button>
                          </form>
                      </fieldset>
                  ...
                  <div class="card-body">
                      <fieldset class="form-group">
                          <form method="POST" action="cadastros/material.php">
                            <p>Descrição</p>
                            <input type="text" class="form-control" id="basicInput" name="txt_descricao_mat"> <br>
                            <p>Tipo</p>
                            <select class="form-control" id="basicSelect" name="sel_tipo_mat">
                            <?php while($dados=mysqli_fetch_array($sql)){?>
                              <option value="<?php echo $dados['TIP_CODIGO'];?>"><?php echo $dados['TIP_DESCRICAO'];?></option>
                            <?php } ?>
                            </select>  <br>
                            <button type="submit" class="btn btn-info btn-min-width mr-1 mb-1">Cadastrar</button>
                          </form>
